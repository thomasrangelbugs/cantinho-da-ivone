const CACHE='ivone-v7-clima-saude';
const FILES=['./','./index.html','./style.css','./script.js','./content.js','./manifest.webmanifest','./assets/icon.svg','./assets/luz_serena.mp3','./assets/hero-luz.jpg','./assets/foto-carinho.svg'];
